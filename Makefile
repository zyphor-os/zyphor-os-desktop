...
add:
	...
	git commit -m "chore: updated v2 zyphor-cli launcher"

	git add pkg/v2/zcli/usr/lib/zyphor/setup/wine
	git commit -m "feat: added v2 zyphor-cli Wine setup command"
