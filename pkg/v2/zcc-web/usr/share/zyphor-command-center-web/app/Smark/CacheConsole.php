...
class CacheConsole
{
    ...
    {
        if ($storage === 'file') {
            $this->storage = new FileCacheConsole();
        } elseif ($storage === 'memory') {
            $this->storage = new MemoryCacheConsole();
        }
    }
