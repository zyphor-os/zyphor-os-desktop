...
int main(int argc, char *argv[])
{
    ...
    // server.setWorkingDirectory("/usr/share/webview"); // production
    server.setWorkingDirectory("webview/usr/share/webview"); // development
    ...
    QWebEngineView view;
    view.resize(900, 500);
    view.setWindowTitle("Welcome To Webview Application");
